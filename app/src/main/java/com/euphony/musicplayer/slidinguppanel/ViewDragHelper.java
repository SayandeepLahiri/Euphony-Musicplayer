...
package com.euphony.musicplayer.slidinguppanel;
...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
         ...
         * @param left        Euphony X coordinate of the left edge of the view
         * @param top         Euphony Y coordinate of the top edge of the view
