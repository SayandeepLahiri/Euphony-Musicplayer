...
import com.euphony.musicplayer.MusicPlayer;
...
import com.euphony.musicplayer.fragments.MainFragment;
import com.euphony.musicplayer.fragments.PlaylistFragment;
import com.euphony.musicplayer.fragments.QueueFragment;
import com.euphony.musicplayer.permissions.Euphony;
import com.euphony.musicplayer.permissions.PermissionCallback;
import com.euphony.musicplayer.slidinguppanel.SlidingUpPanelLayout;
import com.euphony.musicplayer.utils.Constants;
import com.euphony.musicplayer.utils.Helpers;
import com.euphony.musicplayer.utils.NavigationUtils;
import com.euphony.musicplayer.utils.TimberUtils;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Euphony.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            loadEverything();
        } else {
            if (Euphony.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "SongsPro will need to read external storage to display songs on your device.",
                        Snackbar.LENGTH_INDEFINITE)
                        .setAction("OK", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Euphony.askForPermission(MainActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE, permissionReadstorageCallback);
                            }
                        }).show();
            } else {
                Euphony.askForPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE, permissionReadstorageCallback);
            }
        }
    }
    ...
    public void onRequestPermissionsResult(
        ...
        Euphony.onRequestPermissionsResult(requestCode, permissions, grantResults);
    }
